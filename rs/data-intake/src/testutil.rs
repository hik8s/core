...
pub fn save_resource(resource_json: &serde_json::Value, route: &str) -> io::Result<PathBuf> {
    ...
    // let hash = calculate_hash(resource_json);
    let path = Path::new(".testdata7").join(route);
